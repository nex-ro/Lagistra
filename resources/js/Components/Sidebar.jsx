...
export default function Sidebar({ isOpen, onToggle }) {
    ...
    const menuItems = [
        ...
        { name: 'Kebun', icon: Layers, href: '/kebun', color: 'teal' },
        { name: 'Legalitas & HGU', icon: FileText, href: '/legalitas', color: 'blue' },
        { name: 'Produksi', icon: BarChart3, href: '/produksi', color: 'amber' },
        { name: 'Sustainability', icon: Database, href: '/sustainability', color: 'green' },
        { name: 'Data & Citra', icon: Database, href: '/data-citra', color: 'purple' },
    ];
